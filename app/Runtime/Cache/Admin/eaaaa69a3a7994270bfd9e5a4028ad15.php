                        ...
                        <tr>
                          <td>
                            ...
                            <div class="layui-inline" style="margin-top: 5px;">
                              <div class="layui-form-item">
                                <label class="layui-form-label">任务行业分类</label>
                                <div class="layui-input-inline">
                                  <?php if(is_array($type)): foreach($type as $key=>$v): ?><input type="checkbox" name="type[<?php echo ($v["id"]); ?>]" lay-skin="primary" title="<?php echo ($v["title"]); ?>" checked=""><?php endforeach; endif; ?>
                                </div>
                              </div>
                            </div>  
            ...
            <div class="row"> 
                  ...
                  <div class="col-xs-9">
                      <div class="panel panel-default">
                        ...
                        <div class="panel-body" id="grid_table">
                      ...
                      <div class="panel panel-default">
                        ...
                        <div class="panel-body" id="grid_table_1">
                  ...
                  <div class="col-xs-3">
                      <div class="panel panel-default">
                        ...
                        <div class="panel-body" id="grid_table_2">
...
<![endif]-->
    ...
    <script type="text/javascript">
      ...
      function _ajax_get_row_info(id){
          ...
          $.ajax({  
              async:false,
              type:'get',  
              url : "<?php echo U('Admin/Tender/ajax_get_row_info');?>",
              data:{
                id:id
              },
              dataType : 'json',
              success  : function(json) {  
                  if(json.code == 0){
                      ...
                      $('#dialog-confirm_join .id').val(data.id);
                      $('#dialog-confirm_join .title').html(data.title);
                      $('#dialog-confirm_join .time').html(data.time);
                      $('#dialog-confirm_join .content').html(data.content);
      ...
      function _ajax_get_grid_data(types){
          var grid_data;
          $.ajax({   
              async:false,
              type:'get',  
      ...
      function _ajax_get_grid_data_1(types){
          var grid_data_1;
          $.ajax({   
              async:false,
              type:'get',  
      ...
      function _ajax_get_grid_data_2(types){
          var grid_data_2;
          $.ajax({   
              async:false,
              type:'get',  
      ...
      function init_page(types){
          var grid_data=_ajax_get_grid_data(types);
          var grid_data_1=_ajax_get_grid_data_1(types);
          var grid_data_2=_ajax_get_grid_data_2(types);
      ...
      function optionsFormatter(cellvalue, options, rowdata){ 
          return "<button class='btn btn-primary btn-xs id-btn-dialog2_join' title='id-btn-dialog2_join' data-id='"+rowdata.id+"'><i class='icon-edit bigger-110'></i>参与</button>";
      }

      function init_grid_table(grid_data){
          $('#grid_table').html('<table id="grid-table"></table><div id="grid-pager"></div>');
      ...
      function init_grid_table_1(grid_data_1){
          $('#grid_table_1').html('<table id="grid-table-1"></table><div id="grid-pager-1"></div>');
      ...
      function init_grid_table_2(grid_data_2){
          $('#grid_table_2').html('<table id="grid-table-2"></table><div id="grid-pager-2"></div>');
    ...
    <!-- 确认弹框 start-->
    <div id="dialog-confirm_join" class="hide">
       <div class="row">

            <div class="col-xs-12">
                <div class="panel panel-default">
                  <div class="panel-heading title" style="text-align:center;">标题</div>
                  <div class="panel-heading time" style="text-align:center;">2012-12</div>
                    ...
                    <td class="center">
                      <div class="layui-inline">
                        <div class="layui-form-item">
                          ...
                          <div class="layui-input-inline">
                            <input type="text" name="contact_people" lay-verify="required" autocomplete="off" class="layui-input contact_people">
                          </div>
                        </div>
                      </div>
                    </td>
                    <td>
                      <div class="layui-inline">
                        <div class="layui-form-item">
                          ...
                          <div class="layui-input-inline">
                            <input type="text" name="contact_phone" lay-verify="required" class="layui-input contact_phone">
                          </div>
                        </div>
                      </div>
                    </td>
                ...
                <tfoot>
                  <tr>
                    <td colspan="2" style="text-align:center;">
                      <input type="text" name="tender_id" lay-verify="required" class="layui-input tender_id">
                      <button class="layui-btn demo1_edit" lay-submit="" lay-filter="demo1_edit">报名</button>
                    </td>
                  </tr>
                </tfoot>
              </table>
    ...
    <script type="text/javascript">
        $(function() {
            setTimeout("trigger_search()",200); 

            //参与
            $( "body" ).on('click','.id-btn-dialog2_join', function(e) {
              e.preventDefault();
              ...
              $( "#dialog-confirm_join" ).removeClass('hide').dialog({
                resizable: false,
                modal: true,
                title: "",
                width:800,
              ...
              $("div[aria-describedby='dialog-confirm_join'] div span.ui-dialog-title").html("<div class='widget-header'><h4 class='smaller'><i class='icon-warning-sign red'></i> 参与：</h4></div>");
            });
        });
    </script>
  </body>
