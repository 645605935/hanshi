...
//  微信消息处理类
class WxmsgModel extends RelationModel{
	protected $appid;
	protected $secrect;
	protected $accessToken;
	function  __construct()
	{
		$this->appid = C('WX_CONFIG.APPID');
		$this->secrect = C('WX_CONFIG.APPSECRET');
	 ...
	 * @return bool
	 */
	public function doSend($touser, $form_id, $template_id, $url, $data){
		$template = array(
			'touser' => $touser,
